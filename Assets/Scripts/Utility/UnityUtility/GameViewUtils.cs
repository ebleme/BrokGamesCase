...
namespace Ebleme.Utility.EditorTools {
    ...
    public static class GameViewUtils {
        ...
        public static void SetFullHDLandscape() {
#if UNITY_ANDROID
            SetSize(FindSize(GameViewSizeGroupType.Android, "1920x1080 Landscape"));
#elif UNITY_IOS
            SetSize(FindSize(GameViewSizeGroupType.iOS, "iPhone 8 Plus  1920x1080 Landscape"));
#endif
        }

        public static void SetFullHDPortait() {
#if UNITY_ANDROID
            SetSize(FindSize(GameViewSizeGroupType.Android, "1920x1080 Portrait"));
#elif UNITY_IOS
            SetSize(FindSize(GameViewSizeGroupType.iOS, "iPhone 8 Plus  1920x1080 Portrait"));
#endif
        }

        public static void SetLandscape(string sizeDesc) {
            if (sizeDesc.IsNullOrEmpty()) {
                SetFullHDLandscape();
                return;
            }
#if UNITY_ANDROID
            SetSize(FindSize(GameViewSizeGroupType.Android, sizeDesc));
#elif UNITY_IOS
            SetFullHDLandscape();
#endif
        }

        public static void SetPortait(string sizeDesc) {
            if (sizeDesc.IsNullOrEmpty()) {
                SetFullHDPortait();
                return;
            }
